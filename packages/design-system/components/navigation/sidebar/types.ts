...
export interface SidebarNavIdentity {
  ...
  expansion?: string;
  /** The mark — an `<OrgLogo>` from the registry, never a pasted image; the rail's white ground is its ground, so the mark stays bare (it carried no tile since 2026-09-06). */
