...
// public/website/ — the website's assets are namespaced now that it mounts as a
// native route group in the hub (they still serve at /website/images/…).
const dest = (rel) => join(ROOT, 'public', 'website', rel);
