...
// The website's public assets are namespaced under public/website/ now that it is
// a native route group in the hub (they serve at /website/…, exactly as they did
// under the app's old basePath). localAssetPath() below still emits a bare
// "/content/…" URL into the ingested HTML — withAssetBasePath() in
// src/lib/website/content adds the /website prefix at render time.
const PUBLIC_DIR = new URL("../../public/website", import.meta.url).pathname;
