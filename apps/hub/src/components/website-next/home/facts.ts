...
export const GLANCE = [
  { label: "Cumulative Disbursement", value: "₹67,977 Crore", note: "Scholarships for Scheduled Castes" },
  { label: "Beneficiary Coverage", value: "19.82 Crore", note: "Cumulative across all schemes" },
  { label: "Release of Funds, FY 2025–26", value: "₹8,731 Crore", note: "Provisional, 14.3% above the previous year" },
] as const;
