  ...
  return (
    <div className="flex items-center gap-3">
      <div className="flex items-center gap-2.5">
        <span className="flex h-9 w-9 items-center justify-center rounded-full bg-navy text-label-2 font-semibold text-white">
          {initials || <Icon name="person" size={16} />}
        </span>
        <div className="hidden sm:block">
          <div className="text-title-3 text-ink">{name}</div>
