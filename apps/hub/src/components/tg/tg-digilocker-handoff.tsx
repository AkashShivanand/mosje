...
/**
 * Where the login's DigiLocker card hands off to, rendered only while
 * `TG_DIGILOCKER.citizen.login` is on (see `app/portals/tg/citizen/sign-in/digilocker`). PROTOTYPE: no identity
 ...
 */
export function TgDigiLockerHandoff() {
