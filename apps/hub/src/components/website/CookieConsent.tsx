  ...
  return (
    ...
    >
      <div className="sa-container flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-start gap-3 text-body-2 text-ink">
        ...
        <div className="flex shrink-0 items-center gap-3">
          <button
            ...
            className="rounded-lg bg-primary px-5 py-2 text-label-1 text-white shadow-xs transition hover:bg-primary-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Accept &amp; Continue
          </button>
        </div>
