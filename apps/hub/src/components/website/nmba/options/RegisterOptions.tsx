  ...
  return (
    <div className="grid overflow-hidden rounded-2xl border border-gray-200 shadow-sm lg:grid-cols-2">
      <div className="bg-white p-6 sm:p-8">
        <h3 className="text-title-1 text-primary-dark">Become a Nasha Mukti Mitr</h3>
        <p className="mt-2 text-body-1 text-ink-muted">Join thousands of volunteers driving a drug-free India. No prior experience needed.</p>
        <ul className="mt-5 space-y-3">
          {POINTS.map(({ icon: iconName, text }) => (
            <li key={text} className="flex items-start gap-3">
              ...
              <span className="text-body-2 text-ink">{text}</span>
            </li>
          ))}
        </ul>
      </div>
      <div className="flex flex-col items-start justify-center gap-4 bg-primary-dark p-6 sm:p-8">
        ...
        <p className="text-title-1 text-white">Ready to make a difference?</p>
        <p className="text-body-2 text-white/70">Registration takes under two minutes.</p>
        <a href={HREF} className="mt-1 inline-flex items-center gap-2 rounded-lg bg-white px-5 py-2.5 text-label-1 text-primary-dark transition hover:bg-yellow">
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
      <div className="flex flex-col gap-1 text-center">
        <h3 className="text-title-1 text-primary-dark">Become a Nasha Mukti Mitr</h3>
        <p className="mx-auto max-w-measure text-body-1 text-ink-muted">Volunteer to support drug-demand reduction in your community.</p>
      </div>
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        {POINTS.map(({ icon: iconName, text }) => (
          <div key={text} className="rounded-xl border border-gray-100 bg-surface-muted/40 p-4">
            ...
            <p className="mt-3 text-body-2 text-ink">{text}</p>
          </div>
        ))}
      </div>
      <div className="mt-6 text-center">
        <a href={HREF} className="inline-flex items-center gap-2 rounded-lg bg-primary px-6 py-3 text-label-1 text-white transition hover:bg-primary-dark">
  ...
  return (
    <div className="rounded-2xl border border-primary/25 bg-primary/5 p-6 shadow-sm sm:p-7">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-title-1 text-ink">Become a Nasha Mukti Mitr</h3>
          <p className="text-body-2 text-ink-muted">Start here — we&rsquo;ll carry your details to the form.</p>
        </div>
      </div>
      <div className="mt-4 flex flex-col gap-2.5 sm:flex-row">
        ...
        <Input
          ...
          className="flex-1"
        />
        <a href={href} className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-lg bg-primary px-5 text-label-1 text-white transition hover:bg-primary-dark">
