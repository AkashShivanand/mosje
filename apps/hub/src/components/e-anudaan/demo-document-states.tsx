...
const STATES: { state: DocState; label: string }[] = [
  ...
  { state: "rejected-empty", label: "Refused — empty file" },
  { state: "rejected-locked", label: "Refused — password-protected" },
  { state: "rejected-unreadable", label: "Refused — cannot be opened" },
