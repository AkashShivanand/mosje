...
export const PM_AJAY_PORTAL_MAP: PmRole[] = [
  ...
  },
  {
    ...
    screens: [
      { route: "/adarsh-gram-district/agency/add", title: "Add", section: "Agency", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/agency/list", title: "List", section: "Agency", kind: "worklist", status: "planned" },
      { route: "/adarsh-gram-district/dashboard", title: "Dashboard", section: "Overview", kind: "dashboard", status: "planned" },
      { route: "/adarsh-gram-district/format-1", title: "Format 1", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-1/add", title: "Add", section: "Format 1", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/format-2", title: "Format 2", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-2/create", title: "Create", section: "Format 2", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/format-3a/add", title: "Add", section: "Format 3a", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/format-3a/household", title: "Household", section: "Format 3a", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-3a/survey-edit", title: "Survey Edit", section: "Format 3a", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-3b", title: "Format 3b", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-3b/add", title: "Add", section: "Format 3b", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/format-3b/list", title: "List", section: "Format 3b", kind: "worklist", status: "planned" },
      { route: "/adarsh-gram-district/format-4", title: "Format 4", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-4/form", title: "Form", section: "Format 4", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/format-6", title: "Format 6", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/manage-adarsh-gram/declare", title: "Declare", section: "Manage Adarsh Gram", kind: "manage", status: "planned" },
      { route: "/adarsh-gram-district/manage-adarsh-gram/requests", title: "Requests", section: "Manage Adarsh Gram", kind: "manage", status: "planned" },
      { route: "/adarsh-gram-district/manage-mom", title: "Manage MoM", section: "Overview", kind: "manage", status: "planned" },
      { route: "/adarsh-gram-district/manage-vdp/generate-complete-vdp", title: "Generate Complete Vdp", section: "Manage Vdp", kind: "form", status: "planned" },
      { route: "/adarsh-gram-district/manage-vdp/unlock-vdp-request", title: "Unlock Vdp Request", section: "Manage Vdp", kind: "manage", status: "planned" },
      { route: "/adarsh-gram-district/remove-village", title: "Remove Village", section: "Overview", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/reports", title: "Reports", section: "Overview", kind: "report", status: "planned" },
      { route: "/adarsh-gram-district/submit-progress/format-4", title: "Format 4", section: "Submit Progress", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/submit-progress/format-5", title: "Format 5", section: "Submit Progress", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/submit-progress/format-7", title: "Format 7", section: "Submit Progress", kind: "page", status: "planned" },
      { route: "/adarsh-gram-district/user-management", title: "User Management", section: "Overview", kind: "page", status: "planned" },
    ],
  },
  {
