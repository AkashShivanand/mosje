...
const OPTIONS: Option[] = [
  ...
  },
  {
    ...
    what: "Open it from the corner of an ordinary page. The same five questions, one per screen, on a surface that is already built. This one runs the design system's own Chatbot component, not a copy of it.",
    file: "chatbot",
  },
];
