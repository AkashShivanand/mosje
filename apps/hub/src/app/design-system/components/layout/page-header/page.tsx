...
export default function PageHeaderDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Standardized internal page masthead with title, metadata line, action buttons, and semantic heading level."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Page Header is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <PageHeader title="PM-AJAY Grant Application" meta="Last updated: 27 Aug 2026" />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Include concise action buttons in the PageHeader action slot.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not place more than one `<h1>` element on a page.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { PageHeader } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  },
  {
    ...
    "default": "undefined",
    "description": "Supporting timestamp or subtitle."
  },
  {
    "name": "actions",
    "type": "React.ReactNode",
    ...
    "description": "Action button group."
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<PageHeader title="PM-AJAY Grant Application" meta="Last updated: 27 Aug 2026" />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Title rendered as semantic `<h1>` landmark with clear labeling."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Page Header" />
    </article>
  );
}
