...
export default function ContainerDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Max-width responsive bounding box (1280px standard) centering content with responsive horizontal gutters."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Container is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <Container size="page"><div style={{ padding: "var(--sa-padding-24)", background: "var(--sa-bg-brand-primary-subtler)", textAlign: "center", borderRadius: "var(--sa-shape-6)" }}>Centred Estate Content Column</div></Container>
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Wrap all page body content in Container to maintain estate-wide alignment.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not exceed 1280px max-width on reading content columns.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { Container } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  {
    "name": "size",
    "type": "\"page\" | \"narrow\" | \"prose\" | \"full\"",
    "default": "\"page\"",
    "description": "Maximum width container constraint."
  },
  {
    "name": "children",
    "type": "React.ReactNode",
    "required": true,
    "description": "Child layout elements."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<Container size="page"><div style={{ padding: "var(--sa-padding-24)", background: "var(--sa-bg-brand-primary-subtler)", textAlign: "center", borderRadius: "var(--sa-shape-6)" }}>Centred Estate Content Column</div></Container>`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Content reflows without horizontal scrollbars from 320px to 4K displays."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Container" />
    </article>
  );
}
