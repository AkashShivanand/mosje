...
export default function FooterDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Slim dark-navy application shell footer containing developer credits (NeGD / NIC), version numbers, and statutory policy links."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Footer is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <Footer links={[{ label: "Terms of Use", href: "/terms" }, { label: "Privacy Policy", href: "/privacy" }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Include standard government portal credits and security audit compliance dates.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not place multi-column navigation links in the portal footer; use SiteFooter instead.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { Footer } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "FooterLink[]",
    "default": "undefined",
    "description": "Array of policy links (Privacy, Terms, Security)."
  },
  {
    "name": "copyright",
    "type": "React.ReactNode",
    "default": "undefined",
    "description": "Statutory credit line."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<Footer links={[{ label: "Terms of Use", href: "/terms" }, { label: "Privacy Policy", href: "/privacy" }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Enclosed inside `<footer>` landmark."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Tabs through footer links."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Footer" />
    </article>
  );
}
