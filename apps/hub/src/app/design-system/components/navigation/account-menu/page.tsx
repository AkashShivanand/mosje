...
export default function AccountMenuDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Dropdown profile menu displaying logged-in officer credentials, designation, portal switch links, and secure sign-out actions."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Account Menu is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Always include explicit officer designation in government portal account menus.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not omit secure sign-out action.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { AccountMenu } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "HeaderAccount",
    "required": true,
    "description": "Logged in officer name and role."
  },
  {
    "name": "items",
    "type": "AccountMenuItem[]",
    "default": "undefined",
    "description": "Dropdown menu action items."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<AccountMenu account={{ name: "Dr. R. Sharma", role: "State Admin" }} items={[{ label: "My Profile", onSelect: () => console.log("profile") }, { label: "Sign Out", onSelect: () => console.log("logout") }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Menu button carries aria-haspopup=\"menu\" and aria-expanded."
  },
  {
    "criterion": "2.1.1 Keyboard Navigation",
    "level": "AA",
    "description": "ArrowDown/ArrowUp traversal through menu items."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Opens the account menu and focuses the first item."}</td>
                        </tr>
                        <tr>
                          ...
                          <td>{"Closes the menu and returns focus to the account button."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Account Menu" />
    </article>
  );
}
