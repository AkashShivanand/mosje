...
export default function Ux4gAccessibilityWidgetDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"The canonical Government of India (MeitY / UX4G) floating accessibility toolbar providing text resizing, high contrast, dyslexia fonts, and screen reader helpers."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"UX4G Accessibility Widget is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Mount UX4GAccessibilityWidget at the root layout of every public MoSJE application.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not hide or disable the accessibility widget on citizen-facing portals.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { UX4GAccessibilityWidget } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "description": "Enable telemetry (disabled by default)."
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<UX4GAccessibilityWidget />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Enables up to 200% font zoom without loss of functionality."
  },
  {
    "criterion": "1.4.1 Color Contrast",
    "level": "AA",
    "description": "Provides instant dark mode, high contrast, and monochrome modes."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Focuses the floating widget trigger button."}</td>
                        </tr>
                        <tr>
                          ...
                          <td>{"Closes the opened accessibility tool panel."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="UX4G Accessibility Widget" />
    </article>
  );
}
