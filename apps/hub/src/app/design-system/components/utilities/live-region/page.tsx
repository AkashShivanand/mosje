...
import { LiveRegion } from "@mosje/design-system";
...
export default function LiveRegionDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Accessible ARIA live announcement utility for broadcasting dynamic search results, form status updates, and async timer alerts to screen readers."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Live Region is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <div style={{ padding: "var(--sa-padding-16)", background: "var(--sa-bg-neutral-base)", border: "1px solid var(--sa-border-neutral-subtle)", borderRadius: "var(--sa-shape-6)" }}><LiveRegion politeness="polite" /><span style={{ fontSize: "var(--sa-type-body-2-size)", color: "var(--sa-text-neutral-base)" }}>LiveRegion mounted (announcements broadcast automatically)</span></div>
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Announce dynamic filter count changes and search result updates using LiveRegion.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not use `assertive` for routine search filter changes; reserve for emergency error alerts.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { LiveRegion } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "default": "\"polite\"",
    "description": "Screen reader interruption level."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<div style={{ padding: "var(--sa-padding-16)", background: "var(--sa-bg-neutral-base)", border: "1px solid var(--sa-border-neutral-subtle)", borderRadius: "var(--sa-shape-6)" }}><LiveRegion politeness="polite" /><span style={{ fontSize: "var(--sa-type-body-2-size)", color: "var(--sa-text-neutral-base)" }}>LiveRegion mounted (announcements broadcast automatically)</span></div>`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Uses `aria-live=\"polite\"` and `role=\"status\"` for non-disruptive announcements."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Live Region" />
    </article>
  );
}
