...
export default function VisitorCounterDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Statutory Government of India website footer element displaying total cumulative citizen visits in seven-segment digit style."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Visitor Counter is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Include VisitorCounter in statutory website footers per GIGW 3.0 guidelines.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not invent misleading non-seeded live metrics.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { VisitorCounter } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "number",
    "default": "247112",
    "description": "Count at seeded date."
  },
  {
    "name": "label",
    "type": "string",
    "default": "\"Total Visits\"",
    "description": "Statutory header label."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<VisitorCounter label="Website Visits" />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "The full visitor count is rendered as plain text for screen readers."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Visitor Counter" />
    </article>
  );
}
