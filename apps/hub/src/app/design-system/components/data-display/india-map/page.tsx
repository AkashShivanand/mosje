...
export default function IndiaMapDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Choropleth SVG map of India illustrating state-wise and union territory scheme coverage, fund disbursals, and inspection counts."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"India Map is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <IndiaMap title="State Beneficiary Coverage" data={[{ state: "Uttar Pradesh", value: 1200 }, { state: "Maharashtra", value: 950 }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Include a data table toggle below the map for full accessible keyboard inspection.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not use unofficial borders or unverified geographic boundary polygons.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { IndiaMap } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "string",
    "required": true,
    "description": "Accessible map title."
  },
  {
    "name": "data",
    "type": "IndiaMapDatum[]",
    "required": true,
    "description": "State-keyed dataset with metric values."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<IndiaMap title="State Beneficiary Coverage" data={[{ state: "Uttar Pradesh", value: 1200 }, { state: "Maharashtra", value: 950 }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Every state path carries aria-label with state name and exact metric."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <div style={{ overflowX: "auto" }}>
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          <td><kbd style={{ fontFamily: "var(--sa-font-mono)", padding: "var(--sa-padding-2) var(--sa-padding-6)", background: "var(--sa-bg-neutral-subtler)", borderRadius: "var(--sa-shape-4)", border: "1px solid var(--sa-border-neutral-subtle)" }}>Tab / Arrow keys</kbd></td>
                          <td>{"Navigates through selectable states."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="India Map" />
    </article>
  );
}
