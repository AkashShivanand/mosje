...
export default function ScatterChartDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Bivariate coordinate plot mapping district inspection frequency against grievance resolution velocity."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Scatter Chart is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <ScatterChart title="District Inspections vs Grievance Velocity" series={[{ name: "Districts", points: [{ x: 10, y: 20 }, { x: 25, y: 45 }] }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Use ScatterChart for statistical distribution and correlation analysis.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not plot thousands of dense unclustered points that degrade browser performance.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { ScatterChart } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  },
  {
    ...
    "type": "ScatterSeries[]",
    "required": true,
    "description": "Data series with (x, y) coordinates."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<ScatterChart title="District Inspections vs Grievance Velocity" series={[{ name: "Districts", points: [{ x: 10, y: 20 }, { x: 25, y: 45 }] }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Data points include accessible labels and keyboard focusability."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Steps through scatter plot coordinates."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Scatter Chart" />
    </article>
  );
}
