...
export default function DonutChartDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Circular proportional ring chart showing budget allocation percentages and scheme demographic shares with central summary slot."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Donut Chart is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <DonutChart title="Budget Distribution" data={[{ label: "Post-Matric", value: 45 }, { label: "Pre-Matric", value: 30 }, { label: "Top Class", value: 25 }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Limit donut slices to 5 or fewer for optimal readability.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not use DonutChart when comparing fine differences between values.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { DonutChart } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  },
  {
    ...
    "type": "ChartDatum[]",
    "required": true,
    "description": "Slice data with labels and values."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<DonutChart title="Budget Distribution" data={[{ label: "Post-Matric", value: 45 }, { label: "Pre-Matric", value: 30 }, { label: "Top Class", value: 25 }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Each slice has aria-label with name and exact percentage."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Focuses donut slices sequentially."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Donut Chart" />
    </article>
  );
}
