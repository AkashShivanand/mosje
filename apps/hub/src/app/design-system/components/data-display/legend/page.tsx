...
export default function LegendDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Categorical and sequential color legend explaining chart series, thresholds, and choropleth scale buckets."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Legend is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <Legend items={[{ label: "Approved", color: "var(--sa-color-status-success)" }, { label: "Pending", color: "var(--sa-color-status-warning)" }, { label: "Rejected", color: "var(--sa-color-status-danger)" }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Position legends above or adjacent to charts to aid rapid comprehension.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not truncate long legend labels without hover tooltips.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { Legend } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "LegendItem[]",
    "required": true,
    "description": "Array of legend items with label, color token, and shape."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<Legend items={[{ label: "Approved", color: "var(--sa-color-status-success)" }, { label: "Pending", color: "var(--sa-color-status-warning)" }, { label: "Rejected", color: "var(--sa-color-status-danger)" }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Structured as an accessible unordered list."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Legend" />
    </article>
  );
}
