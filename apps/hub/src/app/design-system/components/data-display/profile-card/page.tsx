...
export default function ProfileCardDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Government leadership and officer contact card featuring official portrait, designation, ministry division, and contact credentials."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Profile Card is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <ProfileCard title="Dr. Virendra Kumar" subtitle="Hon'ble Union Minister · MoSJE" image={<div style={{ width: "100%", height: "100%", background: "var(--sa-bg-brand-primary-boldest)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--sa-text-neutral-inverse)", fontWeight: 700 }}>VK</div>} tag="Minister" />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Use official high-resolution government portrait photos with neutral backgrounds.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not display outdated leadership designations or personal contact numbers.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { ProfileCard } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "required": true,
    "description": "Official's full name and titles."
  },
  {
    "name": "subtitle",
    "type": "React.ReactNode",
    "required": true,
    "description": "Official government post (e.g. \"Hon'ble Union Minister\")."
  },
  {
    "name": "image",
    "type": "React.ReactNode",
    "required": true,
    "description": "Portrait element or Image container."
  },
  {
    "name": "tag",
    "type": "React.ReactNode",
    "default": "undefined",
    "description": "Category or ministry badge."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<ProfileCard title="Dr. Virendra Kumar" subtitle="Hon'ble Union Minister · MoSJE" image={<div style={{ width: "100%", height: "100%", background: "var(--sa-bg-brand-primary-boldest)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--sa-text-neutral-inverse)", fontWeight: 700 }}>VK</div>} tag="Minister" />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Portrait includes descriptive alt text with official name and post."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Profile Card" />
    </article>
  );
}
