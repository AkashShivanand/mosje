...
export default function MetricCardDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Compact analytical card highlighting a single primary numerical statistic, trend delta indicator, and descriptive category label."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Metric Card is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <MetricCard label="Total Scholarships Awarded" value="14,25,890" changeValue="+12.4%" changeDirection="up" changeLabel="vs last year" />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Use Indian numbering (Lakh / Crore) and explicit comparison baselines.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not rely on green/red color alone for trend changes; include upward/downward arrows.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { MetricCard } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  },
  {
    ...
    "type": "string",
    "default": "undefined",
    "description": "Comparison baseline suffix."
  },
  {
    "name": "changeValue",
    "type": "string",
    "default": "undefined",
    "description": "Delta percentage (e.g. \"12.4%\")."
  },
  {
    ...
    "description": "Trend arrow direction."
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<MetricCard label="Total Scholarships Awarded" value="14,25,890" changeValue="+12.4%" changeDirection="up" changeLabel="vs last year" />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Title and numeric values structured with proper heading levels."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Focuses card when configured with an href link."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Metric Card" />
    </article>
  );
}
