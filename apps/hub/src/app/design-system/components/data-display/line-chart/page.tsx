...
export default function LineChartDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Continuous line graph with data point markers for analyzing monthly citizen applications, portal traffic, and fund burn rates."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Line Chart is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <LineChart title="Monthly Applications" labels={["Jan", "Feb", "Mar"]} series={[{ name: "Applications", data: [400, 600, 800] }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Use line charts for continuous temporal trends.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not use line charts for discrete categorical comparisons.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { LineChart } from "@mosje/design-system";`}</CodeBlock>
                </section>
  ...
  },
  {
    ...
    "description": "Array of series."
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<LineChart title="Monthly Applications" labels={["Jan", "Feb", "Mar"]} series={[{ name: "Applications", data: [400, 600, 800] }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Chart lines maintain minimum 3:1 contrast against canvas background."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Steps through data vertices."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Line Chart" />
    </article>
  );
}
