...
export default function ApprovalTimelineDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Vertical progression tracking component showing multi-tier administrative approval stages, timestamps, official notes, and officer designations."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Approval Timeline is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <ApprovalTimeline events={[{ at: "2026-08-12T10:00:00Z", actorDisplayName: "Citizen Portal", actorRoleLabel: "Applicant", action: "SUBMITTED" }, { at: "2026-08-16T14:30:00Z", actorDisplayName: "Dr. R. Sharma", actorRoleLabel: "District Officer", action: "APPROVED" }]} pendingLabel="Awaiting State Disbursal" />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Show officer designation, date, and verification status for full transparency.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not skip intermediate rejected or remanded stages in the historical log.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { ApprovalTimeline } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "required": true,
    "description": "Array of approval stages with status, officer, date, and remark."
  },
  {
    "name": "pendingLabel",
    "type": "string",
    "default": "undefined",
    "description": "Trailing stage currently awaiting action."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<ApprovalTimeline events={[{ at: "2026-08-12T10:00:00Z", actorDisplayName: "Citizen Portal", actorRoleLabel: "Applicant", action: "SUBMITTED" }, { at: "2026-08-16T14:30:00Z", actorDisplayName: "Dr. R. Sharma", actorRoleLabel: "District Officer", action: "APPROVED" }]} pendingLabel="Awaiting State Disbursal" />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Rendered as an ordered semantic list with stage status descriptions."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Focuses interactive action links or remarks on timeline items."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Approval Timeline" />
    </article>
  );
}
