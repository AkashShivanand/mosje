...
export default function ChartFrameDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Underlying SVG viewbox canvas that manages responsive margins, aspect ratios, titles, and legend placements."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Chart Frame is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <div style={{ padding: "var(--sa-padding-20)", background: "var(--sa-bg-neutral-base)", border: "1px solid var(--sa-border-neutral-subtle)", borderRadius: "var(--sa-shape-8)" }}><svg viewBox="0 0 400 120" style={{ width: "100%", height: 120 }}><rect x="10" y="10" width="380" height="100" rx="8" fill="var(--sa-bg-brand-primary-subtler)" /><text x="200" y="65" textAnchor="middle" fill="var(--sa-text-brand-primary-base)" fontWeight="600">Standardized SAMAVESH Chart Canvas Frame</text></svg></div>
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Wrap all custom SVG charts inside ChartFrame for consistent padding and scaling.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not hardcode pixel dimensions in inner SVG paths without using viewBox scaling.",
                        preview: (
                  ...
                  <PropsTable props={[
  {
    ...
    "type": "number",
    "default": "500",
    "description": "SVG coordinate width."
  },
  {
    "name": "height",
    "type": "number",
    "default": "300",
    "description": "SVG coordinate height."
  },
  {
    "name": "children",
    "type": "React.ReactNode",
    "required": true,
    "description": "SVG chart paths, bars, lines, and axes."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<div style={{ padding: "var(--sa-padding-20)", background: "var(--sa-bg-neutral-base)", border: "1px solid var(--sa-border-neutral-subtle)", borderRadius: "var(--sa-shape-8)" }}><svg viewBox="0 0 400 120" style={{ width: "100%", height: 120 }}><rect x="10" y="10" width="380" height="100" rx="8" fill="var(--sa-bg-brand-primary-subtler)" /><text x="200" y="65" textAnchor="middle" fill="var(--sa-text-brand-primary-base)" fontWeight="600">Standardized SAMAVESH Chart Canvas Frame</text></svg></div>`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Includes role=\"img\" and aria-labelledby linking to chart title."
  }
]} />
                </section>
      ...
      <FeedbackBar componentName="Chart Frame" />
    </article>
  );
}
