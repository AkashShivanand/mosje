...
import { FilterBar } from "@mosje/design-system";
...
export default function FilterBarDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Universal horizontal control bar for filtering data tables, maps, and chart queries by fiscal year, state, scheme, and status."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Filter Bar is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <FilterBar><span style={{ fontSize: "var(--sa-type-body-2-size)", color: "var(--sa-text-neutral-base)" }}>State: All India</span></FilterBar>
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Include a clear \"Reset Filters\" action whenever more than 2 filters are present.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not hide active filter states inside collapsed menus without an active badge.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { FilterBar } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "required": true,
    "description": "Filter inputs, Select dropdowns, and search controls."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<FilterBar><span style={{ fontSize: "var(--sa-type-body-2-size)", color: "var(--sa-text-neutral-base)" }}>State: All India</span></FilterBar>`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Filter bar controls carry explicit accessible labels."
  },
  {
    "criterion": "2.4.3 Focus Order",
    "level": "AA",
    "description": "Sequential tabbing through filters from primary to secondary."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Cycles through filter controls and actions."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Filter Bar" />
    </article>
  );
}
