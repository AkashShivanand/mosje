...
export default function KpiRowDocPage(): React.JSX.Element {
  return (
    <article className="docs-article" style={{ maxWidth: "1024px", margin: "0 auto", paddingBottom: "var(--sa-section-56)" }}>
      ...
      <header style={{ marginBottom: "var(--sa-stack-32)" }}>
        ...
        <p style={{ ...proseStyle, marginTop: "var(--sa-stack-12)" }}>
          {"Horizontal metric summary row presenting key performance indicators, grant disbursals, and scheme beneficiary totals at a glance."}
        </p>
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <p style={proseStyle}>
                    {"Kpi Row is designed to enforce consistent interaction, visual hierarchy, and government compliance across all MoSJE digital properties."}
                  </p>
                  ...
                  >
                    ...
                    <div style={{ background: "var(--sa-bg-neutral-base)", padding: "var(--sa-padding-20)", borderRadius: "var(--sa-shape-6)", border: "1px solid var(--sa-border-neutral-subtle)" }}>
                      <KpiRow items={[{ label: "Total Funds", value: "₹ 1,240 Cr" }, { label: "Beneficiaries", value: "4.2 Lakh" }]} />
                    </div>
                  </div>
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <DoDont
                    cards={[
                      {
                        type: "do",
                        label: "Display top-level statutory totals in KpiRow.",
                        preview: (
                      ...
                      {
                        type: "dont",
                        label: "Do not place more than 5 KPI cards in a single row.",
                        preview: (
            ...
            content: (
              <>
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`import { KpiRow } from "@mosje/design-system";`}</CodeBlock>
                </section>
                  ...
                  <PropsTable props={[
  {
    ...
    "required": true,
    "description": "Array of MetricCard configurations."
  },
  {
    "name": "span",
    "type": "number",
    "default": "undefined",
    "description": "Column span inside DashboardGrid."
  }
]} />
                </section>
                ...
                <section style={sectionStyle}>
                  ...
                  <CodeBlock>{`<KpiRow items={[{ label: "Total Funds", value: "₹ 1,240 Cr" }, { label: "Beneficiaries", value: "4.2 Lakh" }]} />`}</CodeBlock>
                </section>
              </>
            ),
          },
                  ...
                  <A11yChecklist items={[
  {
    ...
    "level": "AA",
    "description": "Structured as a semantic grouping with summary values."
  }
]} />
                </section>
                    ...
                    <table className="props-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>{"Navigates between interactive KPI metric cards."}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <FeedbackBar componentName="Kpi Row" />
    </article>
  );
}
