      ...
      <Card className="p-6">
        <form className="space-y-5" onSubmit={submit}>
          <Field label="Password History Count">
            ...
            <span className="mt-1 block text-body-3 text-ink-hint">Enter the number of previous passwords to retain</span>
          </Field>
          <Field label="Password Complexity Level">
            ...
            <span className="mt-1 block text-body-3 text-ink-hint">Enter the required complexity level</span>
          </Field>
          <Field label="Minimum Password Length">
            <TextInput inputMode="numeric" value={String(form.minLength)} onChange={(e) => setForm({ ...form, minLength: num(e.target.value) })} />
            <span className="mt-1 block text-body-3 text-ink-hint">Enter the minimum number of characters</span>
          </Field>
          <Field label="Allowed Special Characters">
            ...
            <span className="mt-1 block text-body-3 text-ink-hint">Enter special characters allowed in passwords</span>
          </Field>
          <Field label="Maximum Invalid Login Attempts">
            ...
            <span className="mt-1 block text-body-3 text-ink-hint">Enter the maximum number of invalid attempts allowed</span>
          </Field>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            {saved && (
              <span className="flex items-center gap-1.5 text-body-2 font-medium text-approve-fg">
