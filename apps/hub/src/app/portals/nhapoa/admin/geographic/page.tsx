      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card className="p-6">
          ...
          <div className="mt-5 space-y-3">
            {byDistrict.map(([d, v]) => (
              <div key={d}>
                <div className="mb-1 flex justify-between text-body-3"><span className="text-ink-muted">{d}</span><span className="font-semibold text-ink">{v}</span></div>
        ...
        <Card className="p-6">
          <h2 className="mb-4 text-title-2 text-ink">State-wise Summary</h2>
          <table className="w-full text-left text-body-2">
            <thead><tr className="border-b border-line text-label-3 uppercase text-ink-hint"><th className="py-2.5 font-semibold">State</th><th className="py-2.5 text-right font-semibold">Total</th><th className="py-2.5 text-right font-semibold">Resolved</th></tr></thead>
