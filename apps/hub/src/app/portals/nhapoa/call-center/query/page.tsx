      ...
      <div>
        ...
        <Card className="max-w-xl p-8 text-center">
          ...
          <div className="mt-5 flex justify-center gap-2">
            <Link href="/portals/nhapoa/call-center/queries" className="rounded-lg bg-navy px-4 py-2 text-sm font-semibold text-white hover:bg-navy-800">View Query Log</Link>
