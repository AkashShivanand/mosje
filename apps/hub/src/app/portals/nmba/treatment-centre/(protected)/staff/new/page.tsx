...
import type { StaffDesignation } from "@/lib/nmba/treatment-centre/types";
...
export default function NewStaffPage() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    router.push("/portals/nmba/treatment-centre/staff");
  };
      ...
      <form onSubmit={handleSave} className="flex flex-col gap-6">
        ...
        <div className="flex justify-end gap-3">
          <Button
            type="button"
            appearance="outlined"
            onClick={() => router.push("/portals/nmba/treatment-centre/staff")}
          >
            Reset
          </Button>
