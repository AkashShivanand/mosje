...
export const metadata: Metadata = {
  ...
  /* The archived design (see lib/website-design/constants.ts). Reached at the
     /website addresses through the demo rail; its own /website-classic addresses
     are copies and must never be indexed. */
