...
import { PageHeader, SearchInput, Button, Field, TextInput, Table, EmptyState } from "@/components/ui";
import { useTg } from "@/lib/store/store";
import type { TenantRecord } from "@/lib/store/types";
  ...
  return (
    <div>
      <PageHeader
        ...
        action={<Button onClick={() => setOpen(true)}><Building2 className="h-4 w-4" /> Add New Tenant</Button>}
      />
