...
import { Button, Card, StatusPill, SlaBadge, Textarea, cnField } from "@/components/ui";
import { useTg } from "@/lib/store/store";
import { ROLES } from "@/lib/roles";
import { canTransition, ROLE_ACTS_ON, type Stage } from "@/lib/store/types";
...
export default function ApplicationDetailPage() {
  ...
  if (!app) {
    return (
      <Card className="p-10 text-center">
        ...
        <Link href="/admin/dashboard" className="mt-3 inline-block text-sm font-semibold text-navy hover:underline">
          ← Back to Dashboard
        </Link>
      </Card>
    );
  ...
  return (
    <div className="mx-auto max-w-5xl">
      <Link href="/admin/dashboard" className="mb-4 inline-flex items-center gap-1.5 text-sm font-semibold text-ink-muted hover:text-navy">
