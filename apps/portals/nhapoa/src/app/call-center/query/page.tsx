...
import { PageHeader, Card, Button, Field, TextInput, Textarea } from "@/components/ui";
      ...
      <div>
        ...
        <Card className="max-w-xl p-8 text-center">
          ...
          <div className="mt-5 flex justify-center gap-2">
            <Link href="/call-center/queries" className="rounded-lg bg-navy px-4 py-2 text-sm font-semibold text-white hover:bg-navy-800">View Query Log</Link>
            <button type="button" onClick={() => { setDone(false); setSubject(""); setMobile(""); }} className="rounded-lg border border-navy/30 px-4 py-2 text-sm font-semibold text-navy hover:bg-navy/5">Log another</button>
          </div>
        </Card>
      </div>
    );
