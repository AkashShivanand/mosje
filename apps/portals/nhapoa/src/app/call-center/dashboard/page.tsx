...
const ACTIONS = [
  { href: "/call-center/caller", icon: Phone, title: "Look up caller", desc: "Look up or create the caller record from their mobile." },
  { href: "/call-center/register-grievance", icon: FilePlus2, title: "Start registration", desc: "File a grievance on the caller's behalf." },
  { href: "/call-center/query", icon: MessageSquare, title: "Log a query", desc: "Record a first-time-resolution (FTR) query." },
  { href: "/call-center/queries", icon: FolderOpen, title: "View query log", desc: "Search and resolve logged queries." },
  { href: "/call-center/directory", icon: Users, title: "Search directory", desc: "Find officers state- and district-wise across the country." },
  { href: "/call-center/track", icon: FileSearch, title: "Track a grievance", desc: "Share the reference and track progress for the caller." },
];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/call-center/faq" className="group flex flex-col rounded-2xl border border-line bg-white p-5 shadow-card transition-colors hover:border-navy/30">
