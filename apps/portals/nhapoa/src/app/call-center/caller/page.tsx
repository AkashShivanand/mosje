        ...
        {result && (
          <div className="mt-6 rounded-xl border border-line p-5">
            ...
            <div className="mt-4 flex gap-2">
              <Link href="/call-center/register-grievance" className="inline-flex items-center gap-2 rounded-lg bg-navy px-4 py-2 text-sm font-semibold text-white hover:bg-navy-800"><FilePlus2 className="h-4 w-4" /> Register Grievance</Link>
              <Link href="/call-center/query" className="inline-flex items-center gap-2 rounded-lg border border-navy/30 px-4 py-2 text-sm font-semibold text-navy hover:bg-navy/5">Log a Query</Link>
            </div>
          </div>
        )}
      </Card>
