...
import { GovTopBar, GovMasthead } from "@/components/gov-chrome";

const CITIZEN_ACTIONS = [
  {
    href: "/register-grievance",
    icon: FileText,
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="nha-hero text-white">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link
              href="/track-status"
              className="inline-flex items-center gap-2 rounded-lg border border-white/40 px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/10"
            >
              Track Status
            </Link>
          </div>
      ...
      <footer className="border-t border-line bg-navy-950 text-white">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-2 px-6 py-4 text-xs">
