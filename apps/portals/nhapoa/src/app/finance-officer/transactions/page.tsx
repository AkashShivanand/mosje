...
import { PageHeader, SearchInput, Button, Card } from "@/components/ui";
import { useNhapoa } from "@/lib/store/store";
import { fmtDate, fmtINR } from "@/lib/case-helpers";
  ...
  return (
    <div>
      <PageHeader
        ...
        action={<div className="flex gap-2"><Button variant="outline"><FileText className="h-4 w-4" /> PDF</Button><Button variant="outline"><Sheet className="h-4 w-4" /> Excel</Button></div>}
      />
