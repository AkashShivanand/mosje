  ...
  return (
    <div>
      <PageHeader
        ...
        action={<Button variant="outline"><Download className="h-4 w-4" /> Export PDF</Button>}
      />
      ...
      <Card className="p-6">
        <div className="mb-4 flex items-center gap-2 text-sm font-bold text-ink"><FileBarChart className="h-4 w-4 text-navy" /> Disposal by status</div>
