...
const CITIZEN_NAV = [
  ...
  { label: "Register Grievance", href: "/register-grievance", icon: FilePlus2 },
  { label: "Register Rescue", href: "/register-rescue", icon: LifeBuoy },
  { label: "Track Status", href: "/track-status", icon: FileSearch },
  { label: "Help & FAQs", href: "/help-faqs", icon: HelpCircle },
];
