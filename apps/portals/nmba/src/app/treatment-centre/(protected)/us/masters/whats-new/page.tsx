...
import { WHATS_NEW } from "@/lib/treatment-centre/masters-extra";
    ...
    },
    {
      ...
      render: (r) => (
        <RowActions>
          ...
          <IconAction icon={Trash2} tone="danger" label={`Delete ${r.title}`} onClick={() => handleDelete(r)} />
        </RowActions>
      ),
    },
  ];
    ...
    <>
      <TCListPage
        ...
        action={
          ...
          >
            <Plus className="h-4 w-4" aria-hidden /> Add New What's New
          </button>
        }
      />
