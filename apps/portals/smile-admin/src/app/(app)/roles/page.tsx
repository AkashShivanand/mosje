      ...
      <PageHeader
        ...
        actions={
          <div className="flex items-center gap-sm">
            <Button variant="outline" size="sm" asChild><Link href="/permissions"><ShieldCheck className="h-3.5 w-3.5" /> View permissions</Link></Button>
              ...
              <TR key={r.id}>
                ...
                <TD className="text-right">
                  <Button size="sm" variant="outline" asChild>
                    <Link href={`/roles/${r.id}/edit`}><Edit className="h-3.5 w-3.5" /> Edit</Link>
                  </Button>
                </TD>
              </TR>
            ))}
