...
export default function ComposePage() {
  ...
  return (
    <div className="space-y-lg">
      <PageHeader
        breadcrumbs={[{ label: "Communications" }, { label: "Notifications", href: "/notifications" }, { label: "Compose" }]}
        title="Compose notification"
        subtitle="Reach surveyors, IAs, nodal officers or all portal users in a single broadcast."
        actions={<Button variant="outline" size="sm" asChild><Link href="/notifications"><ArrowLeft className="h-3.5 w-3.5" /> Back</Link></Button>}
      />
