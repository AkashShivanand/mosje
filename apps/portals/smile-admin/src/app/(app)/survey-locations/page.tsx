...
import { SURVEY_LOCATIONS } from "@/lib/mock-data";
  ...
  return (
    <div className="space-y-lg">
      <PageHeader
        ...
        actions={<Button size="sm" asChild><Link href="/survey-locations/create"><Plus className="h-3.5 w-3.5" /> Add location</Link></Button>}
      />
