...
import { SANCTION_ORDERS, SCHEMES, type SanctionOrder } from "@/lib/mock-data";
        ...
        actions={
          <div className="flex items-center gap-sm">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href="/fund-monitoring/sanction-orders/create">
                <Receipt className="h-3.5 w-3.5" /> Sanction order
              </Link>
            </Button>
            <Button size="sm" asChild>
              <Link href="/fund-monitoring/nisd-releases/create">
