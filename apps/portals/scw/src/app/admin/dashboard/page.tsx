...
import { Card, FilterSelect, StatusPill } from "@/components/ui";
import {
  DASHBOARD_STATS,
  SAGE_APPLICATIONS,
  RECENT_ACTIVITY,
    ...
    <div>
      ...
      <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2">
          <div className="flex items-center justify-between px-6 py-5">
            ...
            <Link href="/admin/sage-applications" className="text-sm font-medium text-navy hover:underline">
              View all
            </Link>
          </div>
      ...
      <Card className="mt-6 lg:w-2/3">
        <div className="flex items-center justify-between px-6 py-5">
          ...
          <Link href="/admin/volunteers" className="text-sm font-medium text-navy hover:underline">
            View all
          </Link>
        </div>
        <table className="w-full text-left text-sm">
