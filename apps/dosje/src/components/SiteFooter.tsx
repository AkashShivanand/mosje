...
const columns: FooterColumn[] = [
  {
    heading: "Department",
    links: [
      { label: "About Ministry", href: "/about-us" },
      { label: "Vision & Mission", href: "/about-us" },
      { label: "Organisational Chart", href: "/about-us" },
      { label: "Ministers & Officials", href: "/whos-who" },
    ],
  },
  {
    heading: "Services",
    links: [
      { label: "Schemes & Benefits", href: "/schemes-services" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Statistics", href: "/about-the-division-statistics-division" },
    ],
  },
];
      ...
      <div className="border-t border-white/15">
        <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-4 px-4 py-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-6">
            ...
            />
            <Image
              src="/images/Digital-India-White.svg"
              alt="Digital India"
              width={90}
              height={40}
              className="h-10 w-auto"
