      ...
      <div className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <div className="flex flex-col items-center text-center">
            <Image src="/images/National-Emblem-logo.svg" alt="National Emblem of India" width={48} height={62} className="h-16 w-auto" />
          ...
          <Link href="/" className="mt-6 flex items-center justify-center gap-1.5 text-[14px] text-gov-blue hover:underline">
