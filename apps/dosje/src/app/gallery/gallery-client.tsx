...
const IMAGES: GalleryImage[] = [
  { src: "/images/Banner-6.png", caption: "SAMAVESH outreach programme" },
  { src: "/images/Banner-7.png", caption: "Skill-development initiative under SMILE" },
  { src: "/images/Banner-8.png", caption: "Scholarship felicitation ceremony" },
  { src: "/images/Banner-9.png", caption: "Nasha Mukt Bharat Abhiyaan awareness drive" },
  { src: "/images/Banner-10.png", caption: "Dr. Ambedkar Jayanti commemoration" },
  { src: "/images/portal-banner-images.png", caption: "Launch of citizen-service portals" },
  { src: "/images/5-234x300.jpg", caption: "Beneficiary interaction camp" },
  { src: "/images/3-300x251.jpg", caption: "Community empowerment workshop" },
  { src: "/images/65811748325059-300x291.jpg", caption: "Field visit to an Adarsh Gram" },
];
