...
const OPTIONS = [
  ...
  { surface:"The Home Page · Option B of 3", title:"Find Schemes for You — two questions",
    ...
    pros:["Both questions change the list; nothing is asked for its own sake","Ends at the place to apply, not at a page of text","Persons with disabilities are directed to DEPwD instead of shown nothing","Built as a website section from the design system, over the validated master"],
