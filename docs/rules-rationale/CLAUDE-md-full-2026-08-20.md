# CLAUDE.md — full narrative version (archived 2026-08-20)

> `CLAUDE.md` was compressed to its operative directives to cut per-turn token cost.
> Nothing was deleted: this file is the complete prior text, kept for the incident
> records and rationale behind each rule. The live `CLAUDE.md` links here.
